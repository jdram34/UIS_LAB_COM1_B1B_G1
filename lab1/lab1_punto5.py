...
# Author: Anwar_Cuello_Juan_Ramirez_Jhaider_Ariza_B1B_G1
...
class lab1_punto2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Descargas/rebelion_joearroyo.wav', True)
